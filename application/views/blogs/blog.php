      ...
      foreach ($latest as $value) {
        if($leng == 0){
          ...
          <div class="uk-child-width-1-2@s uk-child-width-1-3@m small-blog-article" uk-grid>
            ...
            <div>
              <div class="blog-image">
                <a class="uk-link-heading" href="<?= base_url("slugdata/{$slug}") ?>"><img src="<?php echo base_url('assets/images/blog2.JPG') ?>"></a>
              </div>
              <div class="blog-text">
                <div class="blog-published">
                  <a href="<?= base_url("category/{$value->cat_name}/1") ?>"><?php echo $value->cat_name; ?></a>
                ...
                <a class="uk-link-heading" href="<?= base_url("slugdata/{$slug}") ?>"><h4><?php echo $title; ?></h4></a>
